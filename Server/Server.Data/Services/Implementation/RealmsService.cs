...
//                    Game region = await this.CreateRegion("R_" + DateTime.UtcNow.Ticks.ToString(), 1, dbRealm);
...
//        private void AssignDwelling(Avatar avatar, Game region, DwellingType type, bool isOwner)
//        {
...
//        private Hero CreateHero(string heroName, HeroBlueprint blueprint, Game region, Avatar avatar)
//        {
...
//        private async Task<Game> CreateRegion(string name, int level, Realm realm)
//        {
//            int width;
//            int height;
...
//        public IQueryable<Game> GetRegions(int[] regionIds)
//        {
//            var regions = _context.Games
//                .Include(r => r.Rooms)
